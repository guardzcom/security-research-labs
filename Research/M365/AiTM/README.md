...
|----------|-------------|
| **AiTM_Attack_Tools_Landscape_Feb2026.xlsx** | Adversary-in-the-Middle (AiTM) attack tools landscape (February 2026). Survey of tooling used in token-theft and MFA-bypass phishing against M365/Entra, including open-source, commercial, and underground tools. Use for detection prioritization, threat intel mapping, and purple-team scope. |
...
- **Purple-team M365:** [Purple-Team-Emulation/M365/](../../../Purple-Team-Emulation/M365/) and [CloudAdversary/M365/](../../../CloudAdversary/M365/).
